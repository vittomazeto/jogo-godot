...
func animate(_velocity: Vector2) -> void: # ao colocar o _ na frente do velocity ele comenta e para de dar os warnings, e cada inimigo tem seu próprio script de animação
	pass
