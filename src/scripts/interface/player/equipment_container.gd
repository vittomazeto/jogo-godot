...
func consumable_slot(item_texture: StreamTexture, item_info: Array):
	consumable_container.update_consumable_slot(item_texture, item_info)
	

func armor_slot(item_texture: StreamTexture, item_info: Array):
	armor_container.update_armor_slot(item_texture, item_info)	
	
	
func weapon_slot(item_texture: StreamTexture, item_info: Array):
